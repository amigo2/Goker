    ...
    function e(d) {
        ...
        function f() {
            function b(b) {
                ...
                b.onload = function() {
                    q.width || q.height || !t || r.setAttribs(b, {
                        width: b.clientWidth,
...
tinymce.PluginManager.add("lists", function(a) {
    ...
    a.on("init", function() {
        ...
        function k(a, b, c) {
            ...
            var e, f, g, h;
            for (g = v.select('span[data-mce-type="bookmark"]', a), c = c || i(b), e = v.createRng(), e.setStartAfter(b), e.setEndAfter(a), f = e.extractContents(), h = f.firstChild; h; h = h.firstChild)
    ...
    function d() {
        ...
        function g(a) {
            ...
            if (a) b = m.getRng(!0), b.setStartBefore(a), b.setEndBefore(a), c = e(a), c && c.nodeValue.charAt(0) == o && (c = c.deleteData(0, 1)), k.remove(a, !0), m.setRng(b);
                ...
                for (;
                    (a = k.get(n)) && a !== d;) c = e(a), c && c.nodeValue.charAt(0) == o && (c = c.deleteData(0, 1)), k.remove(a, !0), d = a
        }
            ...
            if (o && (112 > s || s > 124) && s != l.DELETE && s != l.BACKSPACE) {
                ...
                if (p = d(q)) {
                    ...
                    if (u && t && -1 !== t.className.indexOf("mceTmpParagraph") && t[v ? "previousSibling" : "nextSibling"]) {
                        ...
                        "&nbsp;" === t.innerHTML || "" === t.innerHTML || " " === t.innerHTML ? k.remove(t) : t.className = t.className.replace("mceTmpParagraph", ""), j(B, !v)
                    }
                    var C = m.getRng(!0),
                        D = C.endContainer;
                    if (k.isBlock(D) && k.isBlock(D.nextSibling) && 1 == C.endOffset && s == l.DELETE && (o = c(D.nextSibling)), o && (s == l.DELETE || s == l.BACKSPACE) && k.isBlock(o)) return e.preventDefault(), void k.remove(o)
                }
        ...
        a.on("mousedown", function(c) {
            ...
            d && -1 !== d.className.indexOf("mceTmpParagraph") && d !== c.target && ("&nbsp;" === d.innerHTML || "" === d.innerHTML || " " === d.innerHTML ? k.remove(d) : d.className = d.className.replace("mceTmpParagraph", "")), "false" === b(d) && d == c.target && h()
...
! function(a, b) {
    ...
    d("tinymce/pasteplugin/Utils", ["tinymce/util/Tools", "tinymce/html/DomParser", "tinymce/html/Schema"], function(a, b, c) {
        ...
        return function(e) {
            function f(a) {
                var b, c = e.dom;
                if (b = e.fire("BeforePastePreProcess", {
                        content: a
                    }), b = e.fire("PastePreProcess", b), a = b.content, !b.isDefaultPrevented()) {
                    if (e.hasEventListeners("PastePostProcess") && !b.isDefaultPrevented()) {
                        var d = c.add(e.getBody(), "div", {
                            style: "display:none"
                        }, a);
                        b = e.fire("PastePostProcess", {
                            node: d
                        }), c.remove(d), a = b.node.innerHTML
                    }
            ...
            function g(a) {
                ...
                var b, c = e.dom.getParent(e.selection.getStart(), e.dom.isBlock),
            ...
            function m(a, b) {
                function c(c) {
                    ...
                    var g, h, i, j = !1;
                    if (c)
                        for (g = 0; g < c.length; g++) h = c[g], /^image\/(jpeg|png|gif|bmp)$/.test(h.type) && (i = new FileReader, i.onload = d.bind(null, i), i.readAsDataURL(h.getAsFile ? h.getAsFile() : h), a.preventDefault(), j = !0);
                    return j
                }
            ...
            function r() {
                e.on("keydown", function(b) {
                    ...
                    if (q(b) && !b.isDefaultPrevented()) {
                        ...
                        if (b.stopImmediatePropagation(), w = (new Date).getTime(), a.ie && u) return b.preventDefault(), void e.fire("paste", {
                            ieFake: !0
                        });
                    ...
                    var c = (new Date).getTime(),
                        k = l(b),
                        o = (new Date).getTime() - c,
                        q = (new Date).getTime() - w - o < 1e3,
                        r = "text" == v.pasteFormat || u;
                ...
                r(), e.parser.addNodeFilter("img", function(b) {
                    if (!e.settings.paste_data_images)
                        for (var c = b.length; c--;) {
                            ...
                            d && /^(data:image|webkit\-fake\-url)/.test(d) && (b[c].attr("data-mce-object") || d === a.transparentSrc || b[c].remove())
                        }
                })
            })
        }
            ...
            j.on("BeforePastePreProcess", function(l) {
                function m(a) {
                    ...
                    function c(a, b) {
                        ...
                        if (a = a.firstChild)
                            do
                                if (!c(a, b)) return !1; while (a = a.next);
                        return !0
                    }
                ...
                function j() {
                    function c(a, b, d) {
                        if ("TD" === a.tagName || "TH" === a.tagName) v.setStyle(a, b, d);
                            ...
                            for (var e = 0; e < a.children.length; e++) c(a.children[e], b, d)
                    }
                    var e;
                    l(v, this), w = a.extend(w, this.toJSON()), w["class"] === !1 && delete w["class"], d.undoManager.transact(function() {
                        if (p || (p = d.plugins.table.insertTable(w.cols || 1, w.rows || 1)), d.dom.setAttribs(p, {
                            ...
                            if (u = [], u.push({
                                ...
                                for (var a = 0; a < p.children.length; a++) c(p.children[a], "border", w.border), c(p.children[a], "padding", h(w.cellpadding))
...
tinymce.PluginManager.add("textcolor", function(a) {
    ...
    function g(c) {
        ...
        tinymce.DOM.getParent(c.target, ".mce-custom-color-btn") && (k.hidePanel(), a.settings.color_picker_callback.call(a, function(a) {
            ...
            if (e == i)
                for (e = 0; i - 1 > e; e++) h(b[e], b[e + 1].getAttribute("data-mce-color"));
            h(c, a), d(a)
...
tinymce.PluginManager.add("visualchars", function(a) {
    function b(b) {
        ...
        var h, i, j, k, l, m, n, o, p = a.getBody(),
            q = a.selection;
        if (n = {
                "\xa0": "nbsp",
                "\xad": "shy"
            ...
            for (i = a.dom.select(g(), p), j = i.length - 1; j >= 0; j--) a.dom.remove(i[j], 1);
        q.moveToBookmark(m)
    }
